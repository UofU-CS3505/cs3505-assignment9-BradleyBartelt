    ...
    currentY(0)
{
    ...
    connect(timer, &QTimer::timeout, this, &Animation::updateWorld);
    timer->start(1000 / 30); // 30Hz
}
...
void Animation::setupBox2D(float x, int index, int labelIndex) {
    // Ground body setup
...
void Animation::updateWorld() {
    ...
    if (elapsedTime <= totalTime) {
        ...
        QPixmap pixmap(":/images/cardImages/pokerChip.png"); // Adjust the path to your poker chip image
